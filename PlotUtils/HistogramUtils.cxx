...
//===========================
double MUHist::GetInterquartileRange( const std::vector<double>& vec ){
  if( vec.empty() ) {
    Warning( "MUHist::GetInterquartileRange", "Attempt to get inter-quartile range for an empty vector.  Returning 0." );
    return 0.;
  }
...
//=============================================================================
TH3D* MUHist::divide3D( const TH3D *num, const TH3D *den ){
...
// errors are binomial errors!!
//=============================================================================
TH2D* MUHist::divide2D( const TH2D *num, const TH2D *den ){
...
// errors are binomial errors!!
//=============================================================================
MUH1D* MUHist::divide1D( const MUH1D *num, const MUH1D *den ){

  MUH1D *result = (MUH1D*)num->Clone();
...
// average3D_to_2D()
//=============================================================================
TH2D* MUHist::average3D_to_2D( const TH3D *object, const char *axis1, const char *axis2 ){
...
// average2D_to_1D()
//=============================================================================
MUH1D* MUHist::average2D_to_1D( const TH2D* object, const char *axis1 ){
  ...
  MUH1D *result = new MUH1D( "result", "result", xbins, x_bins );
...
// integrate2D_to_1D()
//=============================================================================
MUH1D* MUHist::integrate2D_to_1D( const TH2D* object, const char *axis1, const double mult, const char *option ){
...
// integrate2D()
//=============================================================================
double MUHist::integrate2D( const TH2D* object, const double mult, const char *option ){
...
//==============================================================
void MUHist::printHisto( TH2D *hist, string name ){
...
// print formatted matrix
//==============================================================
void MUHist::printMatrix( TMatrix matrix, string name ){
...
int MUHist::AddInQuadrature( TH1* a, const TH1* b){

  //check axes
  if( a->GetNbinsX() != b->GetNbinsX() ) {
    Error("MUHist::AddInQuadrature", "Histogram axes not compatible.  Doing nothing." );
    return 1;
  }
...
TMatrixD MUHist::GetErrorsAsMatrix( const TH1D *h )
{
