...
int tryToRead()
{
  ...
  //open the file and get the MUH1D
  TFile f("wroteSomething.root");
  MUH1D* a = (MUH1D*)f.Get("MyHist");

  TFile f2("wroteSomethingElse.root");
  MUH1D* b = (MUH1D*)f2.Get("MyHist");

  //Lets make a clone and divide
  MUH1D* divHist = (MUH1D*)b->Clone("MyHists_Divided");
  ...
  muPlotter.MultiPrint( &cD, "MUH1D_Divide" ); //specify a print name optionally

  //All of the MUSysErrorBands are still in the file as well
